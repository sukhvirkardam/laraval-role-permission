                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="steformdiv">
                                <form id="SignupForm" class="customer_form" action="{{route('candidate.profile',$candidate->user_id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <fieldset class="row">
                                        <div class="col-12">
                                    ...
                                    <p>
                                        ...
                                        <button id="SaveAccount" type="submit" class="btn btn-success px-4">Update Profile</button>
