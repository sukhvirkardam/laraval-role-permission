...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-category pe-3">Edit Job Category</div>
        <div class="ps-3">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="card shadow-none">
                        <div class="card-body">
                            <form class="customer_form row g-3" method="post" action="{{route('job-category.update',$category->id)}}">
							@csrf
                                <div class="col-6 form-group">
                                    <label class="form-label">Job Category<span>*</span></label>
                                    <input type="text" class="form-control" name="title" id="title" value="{{$category->title}}" placeholder="Enter Job category">
                                </div>
                                ...
                                <div class="col-12 text-end">
                                    <button type="submit" class="btn btn-success px-4"><b>+</b> Update Job Category</button>
                                </div>
                            </form>
                        </div>
                    </div>
