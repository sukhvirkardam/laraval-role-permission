...
@section('content')
  ...
  <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-type pe-3">Create Job Type</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="mb-0">Create Job Type</h5>
                    <hr>
                    <div class="card shadow-none">
                        <div class="card-body">
                            <form class="customer_form row g-3" method="post" action="{{route('job-type.store')}}">
							@csrf
                                <div class="col-6 form-group">
                                    <label class="form-label">Job Type<span>*</span></label>
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{old('title')}}" placeholder="Enter Job type">
                                </div>
                                ...
                                <div class="col-12 text-end">
                                    <button type="submit" class="btn btn-success px-4"><b>+</b> Create Job Type</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            title: {
                ...
                validators: {
                    ...
                    stringLength: {
                        min: 6,
                        max: 30,
                        message: 'Job Type must be more than 6 and less than 30 characters long  <br>'
                    },
                    regexp: {
                        regexp: /^[a-zA-Z\s]*$/,
