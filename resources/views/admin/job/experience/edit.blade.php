...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-experience pe-3">Edit Job Experience</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="mb-0">Edit Job Experience</h5>
                    <hr>
                    <div class="card shadow-none">
                        <div class="card-body">
                            <form class="customer_form row g-3" method="post" action="{{route('job-experience.update',$experience->id)}}">
							@csrf
                                <div class="col-6 form-group">
                                    <label class="form-label">Job Experience<span>*</span></label>
                                    <input type="text" class="form-control" name="title" id="title" value="{{$experience->title}}" placeholder="Enter Job experience">
                                </div>
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <select class="form-select" name="status">
                                        ...
                                        @foreach(config('constant.status') as $key=>$value)   
											   ...
											   <option value="{{$key}}"  @if($experience->status==$key) selected  @endif >{{$value}}</option>
                                ...
                                <div class="col-12 text-end">
                                    <button type="submit" class="btn btn-success px-4"><b>+</b> Update Job Experience</button>
                                </div>
                            </form>
                        </div>
                    </div>
