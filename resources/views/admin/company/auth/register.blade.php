              ...
              <div class="row g-0">
                <div class="col-lg-12">
                  <div class="card-body p-4 p-sm-5">
                    <h5 class="card-title">Sign Up as Company</h5>
                    <p class="card-text">See your growth and get consulting support!</p>
                    <form class="form-body" method="POST" action="{{ route('company.signup') }}">
                      @csrf
                      <div class="login-separater text-center mb-4"> <span>SIGN UP WITH EMAIL</span>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <p class="mb-0">Already have an account? <a href="{{ route('company.login') }}">Sign In here</a></p>
                          </div>
                        </div>
                    </form>
                 </div>
