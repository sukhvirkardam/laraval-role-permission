              ...
              <div class="row g-0">
                <div class="col-lg-12">
                  <div class="card-body p-4 p-sm-5">
                    <h5 class="card-title">Sign In as Company</h5>
                    <p class="card-text">See your growth and get consulting support!</p>
                    <form class="form-body" method="POST" action="{{route('company.login') }}">
					@csrf
                      <div class="login-separater text-center mb-4"> <span>ENTER THE DETAILS HERE</span>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <p class="mb-0">Don't have an account yet? <a href="{{ route('company.signup') }}">Sign up here</a></p>
