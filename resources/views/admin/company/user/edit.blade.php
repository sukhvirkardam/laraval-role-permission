            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="card shadow-none">
                        <div class="card-body">
                            <form class="customer_form row g-3 validatedForm"  method="post" action="" enctype="multipart/form-data">
                                @csrf
                                <div class="col-6 form-group">
                                    <label class="form-label">Full Name <span>*</span></label>
                                    <input type="text" id="full_name" class="form-control" value="{{$user->name}}" name="full_name" placeholder="Enter First Name" required>
                                </div>
                                
                                <div class="col-6 form-group">
                                    <label class="form-label">Email Address<span>*</span></label>
                                    <input type="email" id="email" class="form-control" value="{{$user->email}}" name="email" placeholder="Enter Email Address" required>
                                </div>
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input type="password" id="password" class="form-control" value="" name="password" placeholder="Enter Password" required>
                                </div>

                                <div class="col-6 form-group">
                                    <label class="form-label">Confirm Password<span>*</span></label>
                                    <input type="password" id="confirm-password" class="form-control" name="confirm_password" placeholder="Enter Password" value="" required>
                                </div>
