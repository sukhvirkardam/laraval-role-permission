...
<!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{route('agency.sub.user.create')}}" class="btn btn-success">Add New User</a>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                        ...
                        <tr> 
                            ...
                            <td>
                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                    <a href="{{route('agency.sub.user.edit',['id'=>$user->id])}}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
